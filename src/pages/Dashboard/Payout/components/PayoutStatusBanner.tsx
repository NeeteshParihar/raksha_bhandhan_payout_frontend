    ...
    <div className="bg-gray-50 rounded-lg p-5 border border-gray-100 flex flex-col justify-center text-center h-full">
      ...
      {payout.status === PayoutStatus.PENDING && payout.brother && payout.sister && (
        <a
          ...
          className="inline-flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#1ebe5d] text-white font-semibold py-2.5 px-5 rounded-lg shadow-md transition-all duration-200 transform hover:-translate-y-0.5 active:translate-y-0 text-sm mx-auto w-max"
        >
          {/* WhatsApp icon */}
